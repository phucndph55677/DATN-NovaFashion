        ...
        <div class="main-footer d-flex">
            <div class="left-footer">
                <div class="top-left">
                    ...
                    <a href="//www.dmca.com/Protection/Status.aspx?ID=0cfdeac4-6e7f-4fca-941f-57a0a0962777"
                        target="_blank" title="DMCA.com Protection Status" class="dmca-badge">
                        <img src ="https://pubcdn.ivymoda.com/ivy2/images/dmca.png"
                            alt="DMCA.com Protection Status" class="lazy" loading="lazy" />
                    </a>
                    <div class="logo-conthuong">
                        <a target="_blank" href="http://online.gov.vn/Home/WebDetails/36596">
                            <img src="https://pubcdn.ivymoda.com/ivy2/images/img-congthuong.png"
                                alt="img-congthuong" class="lazy" loading="lazy" />
                        </a>
                    </div>
                </div>
                <div class="content-left-ft content-ft">
                    ...
                    <ul class="list-social">
                        <li>
                            <a href="https://www.facebook.com/thoitrangivymoda/" target="_blank">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/0/05/Facebook_Logo_%282019%29.png" alt="ic_fb" class="lazy" loading="lazy" style="width:24px;" />
                            </a>
                        </li>
                        <li>
                    ...
                    <div class="hotline">
                        <a href="tel:02466623434">Hotline: 0899505715</a>
                    </div>
                </div>
            </div>
            <div class="center-footer d-flex">
                ...
                <div class="main-center-ft item-center-ft">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="https://ivymoda.com/about/chinh-sach-giao-nhan-van-chuyen">Chính sách giao
                                nhận vận chuyển</a>
                        </li>
                        <li>
                            <a href="https://ivymoda.com/about/chinh-sach-the-thanh-vien">Chính sách thẻ thành
                                viên</a>
                        </li>
                        <li>
                            <a href="https://ivymoda.com/page/cuahang">Hệ thống cửa hàng</a>
            ...
            <div class="right-footer">
                <div class="register-form">
                    <p class="title-footer">Nhận thông tin các chương trình của NF</p>
                    <form id="frm_subscribe">
                        <input id="email_subscribe" type="text" name="email"
                ...
                <div class="info-right-ft">
                    ...
                    <ul>
                        <li>
                            <a id="app_ios" href="http://ios.ivy.vn" class="link-white" target="_blank"
                                title="Tải App IVYmoda trên App Store">
                                <img src="https://pubcdn.ivymoda.com/ivy2/images/appstore.png"
                                    class="img-fluid lazy" alt="" loading="lazy" />
                            </a>
                        </li>
                    </ul>
                </div>
...
<footer id="footer" class="site-footer">
	<div class="container">
		<div class="coppy-right">©NOva All rights reserved</div>
	</div>
	<!-- .container -->
</footer>