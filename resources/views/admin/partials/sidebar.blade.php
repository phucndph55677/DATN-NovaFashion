<div class="iq-sidebar   sidebar-default">
    <div class="iq-sidebar-logo d-flex align-items-end justify-content-between">
        <a href="{{ route('home') }}" class="header-logo">
            <img src="{{ asset('storage/logo/logo_nf_white.png') }}"
        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="side-menu">
                ...
                <li class="px-3 pt-3 pb-2 ">
                    <span class="text-uppercase small fw-bold">Ứng Dụng</span>
                </li>
                    ...
                    <ul id="app1" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li class="} sidebar-layout ">
                            <a href="{{ route('admin.orders.index') }}" class="svg-icon">
                                ...
                                </i><span class="">Tất Cả Đơn Hàng</span>
                            </a>
                        </li>

                        <li class=" sidebar-layout ">
                            <a href="{{ route('admin.indexReturn') }}" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                                        stroke-width="1.5" stroke="currentColor" class="size-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5A3.375 3.375 0 0 0 6.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0 0 15 2.25h-1.5a2.251 2.251 0 0 0-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 0 0-9-9Z" />
                                    </svg>
                                </i><span class="">Đơn Yêu Cầu Hoàn</span>
                            </a>
                        </li>

                        <li class=" sidebar-layout ">
                            <a href="{{ route('admin.indexRefund') }}" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                                        stroke-width="1.5" stroke="currentColor" class="size-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" 
                                ...
                                </i><span class="">Đơn Hoàn Tiền</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" sidebar-layout ">
                    <a href="{{ route('admin.invoices.index') }}" class="svg-icon">
                        <i class="">
                ...
                <li class=" sidebar-layout">
                    <a href="{{ route('admin.chats.index') }}" class="svg-icon">
                        <i class="">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" 
                                stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" 
                ...
                <li class="sidebar-layout">
                    ...
                    <ul id="app2" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li class="} sidebar-layout ">
                            <a href="{{ route('admin.accounts.client-manage.index') }}" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
