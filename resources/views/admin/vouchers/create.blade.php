                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('admin.vouchers.store') }}" method="POST">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="sale_price" name="sale_price" placeholder="Nhập Giảm Giá (%)" value="{{ old('sale_price') }}">
                                @error('sale_price')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="max_discount" name="max_discount" placeholder="Nhập Giảm Tối Đa (VND)" VNDalue="{{ old('max_discount') }}">
                                @error('max_discount')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="min_price" class="form-label fw-bold text-muted text-uppercase">Giảm Tối Thiểu (VND)</label>
                                <input type="number" class="form-control" id="min_price" name="min_price" placeholder="Nhập Giảm Tối Thiểu (VND)" value="{{ old('min_price') }}">
                                @error('min_price')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="user_limit" name="user_limit" placeholder="Nhập Số Lượt" value="{{ old('user_limit') }}" min="1">
                                @error('user_limit')
                                       <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
