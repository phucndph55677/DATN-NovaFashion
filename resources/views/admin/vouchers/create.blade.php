                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('admin.vouchers.store') }}" method="POST">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="sale_price" name="sale_price" placeholder="Nhập Giảm Giá (VND)" value="{{ old('sale_price') }}">
                                @error('sale_price')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="min_order_value" name="min_order_value" placeholder="Giá Trị Đơn Hàng Tối Thiểu (VND)" value="{{ old('min_order_value') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="quantity" name="quantity" placeholder="Nhập Số Lượng" value="{{ old('quantity') }}" min="1">
                                @error('quantity')
                                       <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="user_limit" name="user_limit" placeholder="Nhập Số Lượt Mỗi Người Dùng" value="{{ old('user_limit') }}" min="1">
                                @error('user_limit')
                                       <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
