                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('admin.accounts.client-manage.update', $client->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nhập Tên Khách Hàng" value="{{ $client->name }}" readonly>
                                @error('name')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email" placeholder="Nhập Email" value="{{ $client->email }}" readonly>
                                @error('email')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="phone" name="phone" placeholder="Nhập Số Điện Thoại" value="{{ $client->phone }}" readonly>
                                @error('phone')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="ranking_id" class="form-label fw-bold text-muted text-uppercase">Xếp Hạng</label>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control" name="address" id="address" rows="4" placeholder="Nhập Địa Chỉ" readonly>{{ $client->address }}</textarea>
                                @error('address')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
