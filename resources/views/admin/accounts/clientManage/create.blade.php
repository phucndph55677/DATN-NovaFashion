...
@section('title', 'Add New Client Account')
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    <nav style="--bs-breadcrumb-divider: url('data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%278%27 height=%278%27%3E%3Cpath d=%27M2.5 0L1 1.5 3.5 4 1 6.5 2.5 8l4-4-4-4z%27 fill=%27currentColor%27/%3E%3C/svg%3E');"
                        ...
                        <ol class="breadcrumb ps-0 mb-0 pb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add Client Account</li>
                        </ol>
                    </nav>
            ...
            <div class="col-lg-12 mb-3 d-flex justify-content-between">
                <h4 class="fw-bold d-flex align-items-center">New Client Account</h4>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('admin.accounts.client-manage.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
