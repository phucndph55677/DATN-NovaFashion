...
@section('title', 'Add New Admin Account')
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-2">
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <a href="{{ route('admin.accounts.admin-manage.index') }}"
            ...
            <div class="col-lg-12 mb-3 d-flex justify-content-between">
                <h4 class="fw-bold d-flex align-items-center">New Admin Account</h4>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="fw-bold mb-3">Admin Information</h5>

                        <form class="row g-3" action="{{ route('admin.accounts.admin-manage.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
