...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            ...
            @php
                // Chuẩn hóa đường dẫn ảnh: loại bỏ /storage/ hoặc storage/ đầu nếu có
                $imagePath = null;
                if ($user->image) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <strong class="d-block text-muted">Ranking ID:</strong>
                                    <span>{{ $user->ranking_id ?: 'N/A' }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <strong class="d-block text-muted">Role ID:</strong>
