...
@section('title', 'Edit Seller Account')
...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                <nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '>';">
                    <ol class="breadcrumb ps-0 mb-0 pb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Seller Account</li>
                    </ol>
                </nav>
                <a href="{{ route('admin.accounts.seller-manage.index') }}" class="btn btn-primary btn-sm">Back</a>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="fw-bold mb-3">Edit Seller Information</h5>
                    ...
                    <form action="{{ route('admin.accounts.seller-manage.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
