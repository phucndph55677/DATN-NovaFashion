...
@section('title', 'Seller Account Management')
            ...
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 my-schedule mb-4">
                    <div class="d-flex align-items-center">
                        <h4 class="fw-bold">Seller Account Management</h4>
                    </div>
                    <div class="create-workform">
                        <div class="d-flex flex-wrap align-items-center">
                            <div class="modal-product-search d-flex flex-wrap">
                                <form class="me-3 position-relative" method="GET"
                                    action="{{ route('admin.accounts.seller-manage.index') }}">
                                    <div class="form-group mb-0">
                                        <input type="text" class="form-control" placeholder="Search Seller (Name, Email)"
                                            aria-label="Search Seller" name="search" value="{{ request('search') }}">
                        ...
                        <div class="table-responsive iq-product-table">
                            <table class="table data-table mb-0">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $imagePath = null;
                                                    if ($seller->image) {
                                                        $imagePath = preg_replace('#^/?storage/#', '', $seller->image);
                                                    }
                                                @endphp
                                                <img
                                            ...
                                            <td>{{ $seller->created_at ? $seller->created_at->format('d/m/Y H:i') : 'N/A' }}</td>
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center gap-2">
                                                    <a href="{{ route('admin.accounts.seller-manage.show', $seller->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.accounts.seller-manage.edit', $seller->id) }}"
                                                    ...
                                                    <form
                                                        ...
                                                        method="POST"
                                                        onsubmit="return confirm('Bạn có chắc chắn muốn xóa tài khoản người bán này không? Hành động này không thể hoàn tác');"
                                                        style="display: inline-block;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-sm btn-icon text-danger"
                                                            data-bs-toggle="tooltip" title="Delete Seller">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center py-4">No seller accounts found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
