    ...
    public function store(Request $request)
    {
        $data = $request->validate(
            [
                ...
                'sale_price' => 'required|numeric|min:1|max:10000000',
                'min_order_value' => 'required|numeric|min:1|max:100000000',
            ...
            [
                ...
                'sale_price.min' => 'Giá giảm phải lớn hơn 0.',
                'sale_price.max' => 'Giá giảm không vượt quá 10.000.000.',
                ...
                'min_order_value.max' => 'Giá trị đơn hàng tối thiểu không vượt quá 100.000.000.',
